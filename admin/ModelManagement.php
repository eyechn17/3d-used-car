...
<body>
  ...
  <div class="container-info">
    <label class="topic">รุ่นรถยนต์</label>
    <div class="info-manage">
      <div class="table-wrapper" id="tb3">
        <table class="table table-hover table-bordered" id="table3">
          ...
          <tbody>
            ...
            $sql = "SELECT DISTINCT(car_model_model) , a.car_model_id,b.car_brand FROM car_model a,car_brand b WHERE a.car_brand_id=b.car_brand_id ORDER BY car_brand";
            ...
            if ($result->num_rows > 0) {
              ...
              while ($row = $result->fetch_assoc()) {
                echo "<tr>";
                echo "<td>" . $row["car_brand"] . " " . $row["car_model_model"] . "</td>";
        ...
        <button type="button" onClick="addmodel()" class="btn add-item-btn">เพิ่ม</button>
        <div class="slide-add" hidden="true" id="divaddmodel">
          <div class="slide-text-add">
            <label>เพิ่มรุ่น</label>
          </div>
          <form id="formaddmodel" action="addModel.php" method="post">
            <div class="browse-file-ipt" id="r">
              <div class="custom-file">
                <select id="selmodel" name="selmodel" class="form-control search-box">
                ...
                <input name="ipaddmodel" type="text" class="" id="ipaddmodel">

              </div>
              <div class="btn-add-group">
                <button type="submit" class="btn btn-success btn-genaral">เพิ่ม</button>
                <button type="button" onClick="closemodel()" class="btn btn-danger btn-genaral">ยกเลิก</button>
              </div>
            </div>
          </form>
        </div>
...
<script type="text/javascript">
  ...
  paginate.init("#table3", options);

  function addmodel() {
    var page = document.getElementById("divaddmodel");
    page.hidden = false;

    ...
    <div class="form-wrapper">
      <div>
        ...
        <form id="pic1" method="post" class="service-img-wrapper">
          ...
          <!-- <img src="./images/content/" class="head-refin-img" /> -->
          <div class="input-group browse-file-ipt">
            <div>
              <input type="file" accept="image/x-png,image/jpeg" class="custom-file-input" name="tpic" id="tpic">
              <label class="custom-file-label bordered" for="tpic">Choose file</label>
        ...
        <div class="service-container">
          <label class="service-topic-header">เงื่อนไข</label>
          <div class="service-rule-wrapper">
            <form id="stext" method="post">
              <textarea id="text2" name="text2" class="service-rule bordered"><?php echo $detel; ?></textarea>
              <input type="submit" class="btn-rule-submit btn btn-success" />
            </form>
          </div>

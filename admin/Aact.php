      ...
      <div>
        ...
        <form id="pic1" method="post" class="service-img-wrapper">
          ...
          <div class="input-group browse-file-ipt">
            <div>
              <input type="file" accept="image/x-png,image/jpeg" class="custom-file-input" name="actpic1" id="actpic1">
              <label class="custom-file-label bordered" for="actpic1">Choose file</label>
        ...
        <div class="service-container">
          <div class="service-topic-wrapper">
            <input type="text" class="service-topic bordered" value="จัดไฟแนนซ์กับ 3D-Used-Car" />
          </div>
          ...
          <form id="pic2" method="post" class="service-img-wrapper">
            ...
            <div class="input-group browse-file-ipt">
              <div>
                <input type="file" accept="image/x-png,image/jpeg" class="custom-file-input" name="actpic2" id="actpic2">
                <label class="custom-file-label bordered" for="actpic2">Choose file</label>

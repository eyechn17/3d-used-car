...
<head>
  ...
  <link href="./assets/css/refinance.css" rel="stylesheet" type="text/css" />
  <link href="./assets/css/act.css" rel="stylesheet" type="text/css" />
...
<body>
  ...
  <div class="container-info">
    <div class="head-img-content">
      <img src="./admin/images/content/<?php echo $pic1; ?>" class="head-refin-img" />
    </div>
    <div class="refin-container-st">
      <label class="topic-head">จัดไฟแนนซ์กับ 3D-Used-Car</label>
    ...
    <div class="refin-container-nd">
      <div>
        <img src="./admin/images/content/<?php echo $pic2; ?>" class="act-img-brochure" />
      </div>
    </div>
  </div>

  ...
  <div class="container-info">
    ...
    <div>
      <div class="suggest-wrapper">
        <label class="topic-head">รถยนต์ที่ค้นหา</label>
        <?php
        include('admin/connect.php');

        if ($brand != "" && $model != "" && $type == "" && $price == "") {
          $sql = "SELECT a.car_id,a.car_brand_id,a.car_model_id,a.car_model_detail,a.car_year,a.car_price,a.car_pic0,a.car_pricepromo,a.car_date,a.car_cts,a.car_detail,b.car_brand,c.car_model_model 
								FROM cars a,car_brand b,car_model c WHERE a.car_brand_id=b.car_brand_id AND a.car_model_id=c.car_model_id AND car_status='0' AND a.car_brand_id ='$brand' AND a.car_model_id = '$model' ORDER BY car_id DESC";
        } elseif ($brand != "" && $model == "" && $type == "" && $price == "") {
          $sql = "SELECT a.car_id,a.car_brand_id,a.car_model_id,a.car_model_detail,a.car_year,a.car_price,a.car_pic0,a.car_pricepromo,a.car_date,a.car_cts,a.car_detail,b.car_brand,c.car_model_model 
								FROM cars a,car_brand b,car_model c WHERE a.car_brand_id=b.car_brand_id AND a.car_model_id=c.car_model_id AND car_status='0' AND a.car_brand_id ='$brand' ORDER BY car_id DESC";
        } elseif ($brand == "" && $model == "" && $type == "" && $price == "") {
          $sql = "SELECT a.car_id,a.car_brand_id,a.car_model_id,a.car_model_detail,a.car_year,a.car_price,a.car_pic0,a.car_pricepromo,a.car_date,a.car_cts,a.car_detail,b.car_brand,c.car_model_model 
          FROM cars a,car_brand b,car_model c WHERE a.car_brand_id=b.car_brand_id AND a.car_model_id=c.car_model_id AND car_status='0' ORDER BY car_id DESC";
        } elseif ($brand != "" && $model == "" && $type != "" && $price == "") {
          $sql = "SELECT a.car_id,a.car_brand_id,a.car_model_id,a.car_model_detail,a.car_year,a.car_price,a.car_pic0,a.car_pricepromo,a.car_date,a.car_cts,a.car_typeid,a.car_detail,b.car_brand,c.car_model_model 
								FROM cars a,car_brand b,car_model c WHERE a.car_brand_id=b.car_brand_id AND a.car_model_id=c.car_model_id AND car_status='0' AND a.car_brand_id ='$brand' AND a.car_typeid = '$type'  ORDER BY car_id DESC";
        } elseif ($brand == "" && $model == "" && $type != "" && $price == "") {
          $sql = "SELECT a.car_id,a.car_brand_id,a.car_model_id,a.car_model_detail,a.car_year,a.car_price,a.car_pic0,a.car_pricepromo,a.car_date,a.car_cts,a.car_typeid,a.car_detail,b.car_brand,c.car_model_model 
								FROM cars a,car_brand b,car_model c WHERE a.car_brand_id=b.car_brand_id AND a.car_model_id=c.car_model_id AND car_status='0' AND a.car_typeid = '$type'  ORDER BY car_id DESC";
        } elseif ($brand == "" && $model == "" && $type == "" && $price != "") {
          if ($price == "1") {
            $min = 100000;
            $max = 200000;
          ...
          $sql = "SELECT a.car_id,a.car_brand_id,a.car_model_id,a.car_model_detail,a.car_year,a.car_price,a.car_pic0,a.car_pricepromo,a.car_date,a.car_cts,a.car_typeid,a.car_detail,b.car_brand,c.car_model_model 
								FROM cars a,car_brand b,car_model c WHERE a.car_brand_id=b.car_brand_id AND a.car_model_id=c.car_model_id AND car_status='0' AND (a.car_price BETWEEN '$min' AND '$max' OR a.car_pricepromo BETWEEN '$min' AND '$max') ORDER BY car_id DESC";
        } elseif ($brand == "" && $model == "" && $type != "" && $price != "") {
          if ($price == "1") {
            $min = 100000;
            $max = 200000;
          ...
          $sql = "SELECT a.car_id,a.car_brand_id,a.car_model_id,a.car_model_detail,a.car_year,a.car_price,a.car_pic0,a.car_pricepromo,a.car_date,a.car_cts,a.car_typeid,a.car_detail,b.car_brand,c.car_model_model 
								FROM cars a,car_brand b,car_model c WHERE a.car_brand_id=b.car_brand_id AND a.car_model_id=c.car_model_id AND car_status='0' AND (a.car_price BETWEEN '$min' AND '$max' OR a.car_pricepromo BETWEEN '$min' AND '$max') AND a.car_typeid = '$type' ORDER BY car_id DESC";
        } elseif ($brand != "" && $model == "" && $type != "" && $price != "") {
          if ($price == "1") {
            $min = 100000;
            $max = 200000;
          ...
          $sql = "SELECT a.car_id,a.car_brand_id,a.car_model_id,a.car_model_detail,a.car_year,a.car_price,a.car_pic0,a.car_pricepromo,a.car_date,a.car_cts,a.car_typeid,a.car_detail,b.car_brand,c.car_model_model 
								FROM cars a,car_brand b,car_model c WHERE a.car_brand_id=b.car_brand_id AND a.car_model_id=c.car_model_id AND car_status='0' AND (a.car_price BETWEEN '$min' AND '$max' OR a.car_pricepromo BETWEEN '$min' AND '$max') AND a.car_typeid = '$type' AND a.car_brand_id ='$brand' ORDER BY car_id DESC";
        } elseif ($brand != "" && $model == "" && $type == "" && $price != "") {
          if ($price == "1") {
            $min = 100000;
            $max = 200000;
          ...
          $sql = "SELECT a.car_id,a.car_brand_id,a.car_model_id,a.car_model_detail,a.car_year,a.car_price,a.car_pic0,a.car_pricepromo,a.car_date,a.car_cts,a.car_typeid,a.car_detail,b.car_brand,c.car_model_model 
								FROM cars a,car_brand b,car_model c WHERE a.car_brand_id=b.car_brand_id AND a.car_model_id=c.car_model_id AND car_status='0' AND (a.car_price BETWEEN '$min' AND '$max' OR a.car_pricepromo BETWEEN '$min' AND '$max')  AND a.car_brand_id ='$brand' ORDER BY car_id DESC";
        }
        //$sql = "SELECT a.car_id,a.car_brand_id,a.car_model_id,a.car_model_detail,a.car_year,a.car_price,a.car_pic0,a.car_pricepromo,a.car_date,a.car_cts,a.car_detail,b.car_brand,c.car_model_model 
        //FROM cars a,car_brand b,car_model c WHERE a.car_brand_id=b.car_brand_id AND a.car_model_id=c.car_model_id AND car_status='0' ORDER BY car_id DESC";
        ...
        if ($result->num_rows > 0) {
          ...
          echo "
          <span style='font-size: 24px; display: block; text-align: center;'>

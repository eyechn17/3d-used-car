    ...
    <div>
      ...
      <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
        <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
          <li class="nav-item">
            <a class="nav-link active-item" href="./index.php">หน้าแรก</a>
          </li>
          <li class="nav-item">
  ...
  <div class="container-info">
    <div class="slick-carousel">
      ...
      $conn->close();
		if($pic1==""){
			...
			echo "<div>
          			<img data-lazy='./admin/images/content/$pic1' class='slick-img' />
        		</div>";
		}
		if($pic2==""){
			...
			echo "<div>
          			<img data-lazy='./admin/images/content/$pic2' class='slick-img' />
        		</div>";
		}
		if($pic3==""){
			...
			echo "<div>
          			<img data-lazy='./admin/images/content/$pic3' class='slick-img' />
        		</div>";
		}
		if($pic4==""){
			...
			echo "<div>
          			<img data-lazy='./admin/images/content/$pic4' class='slick-img' />
        		</div>";
		}
		if($pic1==""&&$pic2==""&&$pic3==""&&$pic4==""){
			echo "<div>
          			<img data-lazy='./admin/images/content/car-tent.jpg' class='slick-img' />
        		</div>";
		}else{
    ...
    <div>
      <div class="suggest-wrapper">
        <label class="topic-head">รถยนต์แนะนำ</label>
        <?php
        include('admin/connect.php');
        ...
        $sql = "SELECT a.car_id,a.car_brand_id,a.car_model_id,a.car_model_detail,a.car_year,a.car_price,a.car_pic0,a.car_pricepromo,a.car_date,a.car_cts,a.car_detail,b.car_brand,c.car_model_model 
								FROM cars a,car_brand b,car_model c WHERE a.car_brand_id=b.car_brand_id AND a.car_model_id=c.car_model_id AND car_status='0' AND car_pricepromo !='0' ORDER BY car_id DESC LIMIT 10";
            ...
            echo "<div class='suggest-row'>
            					...
            					<div class='suggest-box'>
              					<div class='suggest-name'>
                					" . $row["car_brand"] . " " . $row["car_model_model"] . " " . $row["car_model_detail"] . "
              					</div>
    ...
    <div class="service-wrapper">
      <label class="topic-head">บริการอื่นๆ</label>
      <div class="row">
        <div class="col">
          <a href="./refinance.php" class="block-link">
            <div class="col-item">
              <div>
                <img src="./assets/images/logo/transportation.png" class="service-img" />
        ...
        <div class="col">
          <a href="./act.php" class="block-link">
            <div class="col-item">
              <div>
                <img src="./assets/images/logo/lift.png" class="service-img" />
                <div class="text-detail">
                  ต่อ พรบ. กับ 3D-Used-Car
                </div>
              </div>
            </div>
          </a>
        ...
        <div class="col">
          <a href="./trade.php" class="block-link">
            <div class="col-item">
              <div>
                <img src="./assets/images/logo/car.png" class="service-img" />
                <div class="text-detail">
                  ขายรถ กับ 3D-Used-Car
                </div>
              </div>
            </div>
          </a>
